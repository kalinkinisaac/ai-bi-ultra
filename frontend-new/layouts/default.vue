...
await callOnce(chatStore.fetchChats);
  ...
  <Suspense>
    <div class="h-screen w-screen overflow-hidden">
      <div class="w-full flex flex-col gap-4">
        ...
        >
          <div
            class="flex-none flex flex-row justify-between items-center p-3 border-b w-full"
          >
            <AppHeader />
        ...
        <div
          class="flex flex-row gap-6 h-screen max-h-screen w-full overflow-hidden"
        >
